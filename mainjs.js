    ...
    details: function (store) {
      ...
      if (address.trim()) {
        ...
        <p class="d-flex align-items-center">
          ...
          <a class="flex-grow-1" href="https://maps.google.com/maps?saddr=${
            myMap.center["lat"]
          },${myMap.center["lng"]}&daddr=${store["lat"]},${
          store["lng"]
        }" target="new" style="color:${ICON_COLOR} !important;">${address.replace(
          ", ,",
          ", "
        )}</a>
        </p>
    ...
    popup: function (store) {
      ...
      const html = `
        <div class="d-flex flex-column">
          ...
          <div class="p-4">
            <h5 style="font-size:1.5em;color:${ICON_COLOR} !important">${
        store["name"]
      }</h5>
            <div  style="font-size:1.3em;color:${ICON_COLOR}; !important">${address.replace(
        ",,",
        ","
      )}</div>
        ...
        store["lng"]
      }" target="new"  style="font-size:1.3em;color:${ICON_COLOR} !important;border-color:${ICON_COLOR} !important;"><i class="fas fa-car"></i> DIRECTIONS</a>
          </div>
        </div>
          `;
  ...
  stores: {
    store: function (store) {
      ...
      <div class="list-group-item list-group-item-action" >
          <div class="d-flex w-100 justify-content-between align-items-center pointer"  onClick="handle.marker.click(${
            store["id"]
          });">
            <div class="flex-grow-1">
                <h5 class="mb-1">${store["name"]}</h5>
                <p class="my-1"  style="color:#495057 !important;">${address.replace(
                  ", ,",
                  ","
                )}</p>
        ...
        store["lng"]
      }" target="new" style="color:${ICON_COLOR};"><i class="fas fa-car mr-2"></i></a>
              <a href="javascript:void(0);" onclick="handle.marker.click(${
                store["id"]
              });" style="color:${ICON_COLOR};"><i class="fas fa-info-circle ml-2"></i></a>
            </div>
          </div>
